exports.signup = require('../function/user/signup');

exports.login = require('../function/user/login');

exports.refresh = require('../function/user/refresh');

exports.getAll = require('../function/user/getAllUser');
...
exports.activate = require('../function/user/activate');
